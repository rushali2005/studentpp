...
import { View, Text, StyleSheet, Alert, TouchableOpacity, ActivityIndicator, KeyboardAvoidingView, Platform, TextInput, Image } from 'react-native';
      ...
      >
        ...
        <View style={styles.featureContainer}>
          ...
          <View style={styles.featureItem}>
            ...
            <Text style={styles.featureText}>Academic Insights</Text>
          </View>
          <View style={styles.featureItem}>
            <FontAwesome5 name="chart-pie" size={20} color="#fff" />
            <Text style={styles.featureText}>Predictive Models</Text>
          </View>
        </View>
